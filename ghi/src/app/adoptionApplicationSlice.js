...
export const adoptionApplicationSlice = createApi({
  reducerPath: "adoptionApplications",
  baseQuery: fetchBaseQuery({
    baseUrl: process.env.REACT_APP_API_HOST,
  }),
  tagTypes: ["AdoptionApplication"],
  endpoints: (builder) => ({
    ...
    listAdoptionApplications: builder.query({
      ...
      providesTags: (result) => providesList(result, "AdoptionApplication"),
    }),
